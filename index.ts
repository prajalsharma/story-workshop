  ...
  creators: [
    {
      ...
      socialMedia: [
        { platform: "Twitter", url: "https://twitter.com/storyprotocol" },
        { platform: "Website", url: "https://story.foundation" },
      ],
    },
  ],
};
...
const response = await client.ipAsset.mintAndRegisterIp({
  spgNftContract: "0xc32A8a0FF3beDDDa58393d022aF433e78739FAbc", // or your custom contract
  ipMetadata: {
